        ...
        with self._db.client().cursor(row_factory=class_row(RestObj)) as cur:
            cur.execute(
                """
                    ...
                    FROM stg.deliverysystem_restorants
        ...
        with conn.cursor() as cur:
            cur.execute(
                ...
                """,
                {
                    ...
                    "active_from": rest.update_ts,  # Assuming update_ts should be used for active_from
                    "active_to": datetime(9999, 12, 31)  # Setting a default value for active_to
                },
            )
