#v.1.0.2
import logging
from lib.stg.restaurant_loader import RestaurantLoader
from lib.stg.deliveries_loader import DeliveryLoader
import pendulum
...
def load_from_api_to_stg():
    ...
    def load_couriers_task():
        ...
        courier_loader = CouriersLoader(dwh_pg_connect, log)
